...
class WPB_EA_Post_Grid_Slider extends Widget_Base {
    ...
    /**
     * number of categories in post type
     */
    protected function wpb_ea_get_post_category_number(){
        ...
        if ( $wpb_ea_post_type_category ) {
            echo '<span class="wpb-ea-post-cats">in ';
    ...
    /**
     * number of tags in post type
     */
    protected function wpb_ea_get_post_tag_number() {
        $settings              = $this->get_settings_for_display();
        ...
        if ( $wpb_ea_post_type_tags ) { 
            echo '<span class="wpb-ea-post-tags">'. esc_html__( 'at ', 'wpb-elementor-addons' );
                                                ...
                                                switch ( $post_meta ) :
                                                    ...
                                                    case 'author':
                                                        echo '<span class="wpb-ea-post-author">';
                                                            echo esc_html__('by ', 'wpb-elementor-addons' ) . get_the_author_posts_link();
                                                        echo '</span>';                            
                                                        break;

                                                    // category
                                                    case 'category':
                                                        $this->wpb_ea_get_post_category_number();
                                                        break;

                                                    // tags
                                                    case 'tags':
                                                        $this->wpb_ea_get_post_tag_number();
                                                        break;
                                                    ...
                                                    case 'comments': 
                                                        ...
                                                        elseif( $settings['post_types'] == 'product' ) :
                                                            echo esc_html__('Reviews Disabled');
                                                        else :
                                                            echo esc_html__('Comments Disabled');
                                                        endif;
                                                    break;
