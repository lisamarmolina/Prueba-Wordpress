    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       => '',
                'selectors'     => [
                    '{{WRAPPER}} .wpb-timeline-icon' => 'color: {{VALUE}};',
	        ...
	        <div class="wpb-timeline-area wpb-timeline-<?php echo esc_attr( $wpb_ea_timeline_type ); ?> wpb-timeline-shadow-<?php echo esc_attr( $wpb_ea_timeline_shadow ); ?>">
	        	...
	        	<?php foreach ( $settings['wpb_ea_timeline_items'] as $item ) : ?>
					...
					<div class="wpb-timeline-block">
						...
						<?php if( $item['icon'] ): ?>
							<div class="wpb-timeline-icon"><i class="<?php echo esc_attr( $item['icon'] ); ?>"></i></div>
						<?php endif; ?>
						<div class="wpb-timeline-content">
							<?php if( $item['date'] ): ?>
								<div class="wpb-timeline-date"><span><?php echo date_i18n( get_option( 'date_format' ) , strtotime( $item['date']) ); ?></span></div>
							<?php endif; ?>
