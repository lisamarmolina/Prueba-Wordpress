...
class WPB_EA_Video_PopUp extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'image',
            [
                'label'     => esc_html__( 'Choose Image', 'wpb-elementor-addons' ),
    ...
    protected function render() {
        ...
        $video_content_icon = $settings['video_content_icon'];
                ...
                switch ($video_popup_type) {
                    case 'content':
                        ...
                        echo '<div class="wpb-ea-video-popup-content-area">';
                            if($video_content_icon){
                                echo '<i class="video-content-icon '. esc_attr( $video_content_icon ) .'"></i>';
                            }
                            ...
                            echo '<div class="wpb-ea-video-popup-link-area">';
                                if( $settings['wpb_ea_video_link'] ) : 
                                    printf( '<div class="xt-button"><a data-fancybox href="%s"><i class="'.esc_attr( $settings['wpb_ea_video_popup_icon']).' wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;"></i></a></div>', esc_url( $settings['wpb_ea_video_link'] ) ); 
